...
import {
  BabyIcon, Barcode, Brain, ChevronsLeftIcon, ChevronsRightIcon,
  CloudLightning, Construction, HardHat, Shirt, ShirtIcon,
  UmbrellaIcon, WalletCards, WatchIcon
} from 'lucide-react'
      ...
      <section className='py-12 bg-gray-50'>
        <div className='container mx-auto px-4'>
          ...
          <div className='grid grid-cols-2 lg:grid-cols-5 gap-4'>
            {
              categoriesWithIcon.map(categoryItem =>
                <Card key={categoryItem.id} onClick={() => handleNavigatingToListingPage(categoryItem, 'category')}>
